...
namespace Chaarsu.Library.DataTableExtension
{
    public static class DataTableExtension
    {
        ...
        /// <returns></returns>
        /// 
        public static dynamic ToDynamicList(DataTable dt, string className, bool UsePagination = false,bool Addextracolumn = false)
        {
        ...
        private static Type getNewObject(DataColumnCollection columns, string className)
        {
            ...
            assemblyName.Name =ConfigurationManager.AppSettings["AppName"].ToString();
